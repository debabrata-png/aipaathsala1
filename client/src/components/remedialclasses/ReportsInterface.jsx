...
const ReportsInterface = () => {
  ...
  const generateSingleStudentReport = async (formData) => {
    ...
    setIsLoading(true);
    try {
      const response = await ep3.get('/getsinglestudentreportremedial', {
        params: {
  ...
  const handleCourseReportFlow = async () => {
    ...
    setIsLoading(true);
    try {
      const response = await ep3.get('/getfacultycoursesremedial', {
  ...
  const generateCourseReport = async (selectedCourse) => {
    ...
    setIsLoading(true);
    try {
      const response = await ep3.get('/getclassreportbycourseremedial', {
        params: {
          user: global1.userEmail,
  ...
  const generateDateRangeReport = async (dateRange) => {
    ...
    setIsLoading(true);
    try {
      const response = await ep3.get('/getattendancesummarybydateremedial', {
        params: {
          user: global1.userEmail,
          colid: global1.colid,
