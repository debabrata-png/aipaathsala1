...
const CreateClassInterface = () => {
    ...
    const fetchCourses = async () => {
        try {
            const response = await ep3.get("/getcoursebyfacultyremedial", {
                params: {
                    colid: global1.colid,
    ...
    const handleAIGeneration = async () => {
        ...
        try {
            ...
            const saveResponse = await ep3.post("/saveClassesAndAssessmentsremedial", {
                classes,
                assessmentRequests,
    ...
    const generateAITopics = async () => {
        ...
        const response = await ep3.post("/generateclassscheduleremedial", submissionData);
