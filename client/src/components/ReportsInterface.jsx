...
const ReportsInterface = () => {
  ...
  const loadReports = async () => {
    ...
    try {
      ...
      const [att, low, enr, asg, tst, ses, stu, enrt, asgBy, tstBy, syl, sylBy, mat, matBy, ai, col, colBy, lib, noti] = await Promise.all([
        getAttendanceSummary('regular', params),
        getAttendanceBelow('regular', { ...params, threshold: 75 }),
        getCourseSummary('regular', params),
        getAssignmentsSummary('regular', params),
        getTestsSummary('regular', params),
        getAttendanceBySession('regular', params),
        getAttendanceStudentTable('regular', params),
        getCourseOverTime('regular', params),
        getAssignmentsByAssignment('regular', params),
        getTestsByTest('regular', params),
        getSyllabusSummary('regular', params),
        getSyllabusBySession('regular', params),
        getMaterialsSummary('regular', params),
        getMaterialsOverTime('regular', params),
        getAiSummary('regular', params),
        getCollabSummary('regular', params),
        getCollabOverTime('regular', params),
        getLibrarySummary('regular', params),
        getNotificationsSummary('regular', params),
      ]);
      setSummary({
  ...
  return (
    <Box sx={{ height: '100vh', display: 'flex', flexDirection: 'column', backgroundColor: '#f5f5f5' }}>
      <Paper elevation={2} sx={{ p: 2, backgroundColor: '#1976d2', color: 'white' }}>
        <Typography variant="h5" sx={{ fontWeight: 600 }}>📊 Regular Course Reports</Typography>
        <Typography variant="body2">KPIs, bands, and tables for regular courses</Typography>
      </Paper>
