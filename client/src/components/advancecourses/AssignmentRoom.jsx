...
const AssignmentRoom = ({ course, socket, roomId }) => {
  ...
  const fetchAssignments = async () => {
    ...
    try {
      ...
      if (permissions.isStudent) {
        response = await ep3.get('/getassignmentsfirstudentadvance', {
          params: {
        ...
        response = await ep3.get('/getassignmentsbycourseadvance', {
          params: {
            coursecode: course.coursecode,
            colid: global1.colid
          }
  ...
  const fetchSubmissions = async (assignmentId) => {
    ...
    const response = await ep3.get(`/getassignmentsubmissionsadvance/${assignmentId}`);
  ...
  const handleCreateAssignment = async () => {
    ...
    try {
      const response = await ep3.post('/createassignmentadvance', {
  ...
  const handleSubmitAssignment = async () => {
    ...
    try {
      const response = await ep3.post('/submitassignmentadvance', {
        name: global1.userName,
