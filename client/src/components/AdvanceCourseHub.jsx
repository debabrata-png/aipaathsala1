...
import SyllabusRoom from "./advancecourses/SyllabusRoom";
import CourseMaterialRoom from "./advancecourses/CourseMaterialRoom";
import AssignmentRoom from "./advancecourses/AssignmentRoom";
import ManageClassInterfaceByCourse from "./advancecourses/ManageClassInterfaceByCourse";
import EnrollStudentsForCourse from "./advancecourses/EnrollStudentsForCourse";
import EnrollmentRequests from "./advancecourses/EnrollmentRequests";
import AIChatInterface from "./advancecourses/AIChatInterface";
import global1 from "../pages/global1";

const AdvanceCourseHub = ({
  course,
  socket,
  activeTab,
  onChangeTab,
...
export default AdvanceCourseHub;