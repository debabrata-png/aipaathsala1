...
const CreateClassInterface = () => {
    ...
    const fetchCourses = async () => {
        try {
            const response = await ep3.get("/getcoursebyfacultyadvance", {
                params: {
                    colid: global1.colid,
    ...
    const handleAIGeneration = async () => {
        ...
        try {
            ...
            const saveResponse = await ep3.post("/saveClassesAndAssessmentsadvance", {
                classes,
                assessmentRequests,
    ...
    const generateAITopics = async () => {
        ...
        const response = await ep3.post("/generateclassscheduleadvance", submissionData);
