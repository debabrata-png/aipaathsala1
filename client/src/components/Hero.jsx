      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
            Plug into the Future of Teaching <span className="bg-gradient-to-r from-blue-600 to-blue-600 bg-clip-text text-transparent mt-4 inline-block">
              — Just
            </span>
            <br />
            <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mt-4 inline-block">
              Talk to Start
            </span>
          </h1>
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            From projects to assessments, our AI chatbot guides you step by step. No manuals, no training, just teaching made simpler
          </p>
